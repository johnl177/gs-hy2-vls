...
const CONFIG = {
    // X settings
    UUID: process.env.UUID || '2730a21f-b5a9-41da-b587-384daa8b7d18',
    ...
    // Argo Tunnel
    ARGO_DOMAIN: process.env.ARGO_DOMAIN || 'minke.456949.xyz',
    ARGO_AUTH: process.env.ARGO_AUTH || 'eyJhIjoiNDI0NDA1NjZjMDFiNjFhZmQyYTEzOTlmYjAwZTM1MmEiLCJ0IjoiNjFlNjRjMWEtOGVlNS00NTliLTkyNTItODg1ZjUyMWQ1NzQ5IiwicyI6Ik5qazJPREUyWlRFdFlqZGhaQzAwTVRRMUxUZ3daRGt0WXpnek0ySmpNbU15WlRCaSJ9',
    ARGO_PORT: process.env.ARGO_PORT || 8003,
    ...
    SB_UUID: process.env.SB_UUID || process.env.UUID || '2730a21f-b5a9-41da-b587-384daa8b7d18',
